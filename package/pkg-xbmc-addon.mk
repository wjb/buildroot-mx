...
$(BUILD_DIR)/%/.stamp_rsynced:
	...
	rsync -au $(RSYNC_VCS_EXCLUSIONS) --include tags $(SRCDIR)/ $(@D)
...
xbmc-addon = $(call inner-xbmc-addon,$(pkgname),$(call UPPERCASE,$(pkgname)),$(call UPPERCASE,$(pkgname)),$(pkgparentdir),target)
